  ...
  return <MainLayout>
      <section className="bg-gradient-to-r from-blue-600 via-teal-500 to-cyan-500 text-white py-20 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          ...
          <motion.div 
            className="absolute bottom-20 left-[30%] w-8 h-8"
            animate={{ 
              y: [0, -10, 0],
              opacity: [0.3, 0.7, 0.3]
            }}
      ...
      <section className="py-20 bg-gradient-to-b from-blue-50 to-cyan-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <motion.span 
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-blue-800 font-medium text-sm mb-4"
      ...
      <section className="py-20 bg-gradient-to-b from-cyan-50 to-blue-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <motion.span 
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-100 text-cyan-800 font-medium text-sm mb-4"
              initial={{ opacity: 0, scale: 0.5 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 0.3 }}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 relative">
              <motion.div 
                className="absolute -inset-4 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl blur-lg opacity-30"
                animate={{ 
                  opacity: [0.2, 0.5, 0.2] 
                }}
                transition={{ 
              ...
              <motion.div 
                className="absolute -right-4 -bottom-4 bg-gradient-to-br from-teal-400 to-green-500 p-3 rounded-full shadow-xl"
            ...
            >
              <motion.span 
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-100 text-indigo-800 font-medium text-sm mb-4"
                initial={{ opacity: 0, scale: 0.5 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                transition={{ duration: 0.3 }}
              ...
              <div className="space-y-4">
                {[
                  "Analyse en temps réel des données du marché automobile",
                  "Prise en compte de plus de 50 paramètres pour une estimation précise",
                  "Algorithmes d'apprentissage automatique constamment améliorés",
                  "Historique complet des transactions pour des comparaisons pertinentes"
                ].map((item, index) => (
                  <motion.div 
                    key={index} 
      ...
      <section className="py-20 bg-gradient-to-b from-cyan-50 to-blue-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <motion.span 
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-100 text-pink-800 font-medium text-sm mb-4"
              initial={{ opacity: 0, scale: 0.5 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 0.3 }}
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="flex justify-end mb-4 relative z-10">
                  <motion.div 
                    className="text-5xl text-gray-200 font-serif"
                    initial={{ scale: 1 }}
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 via-teal-500 to-cyan-500 text-white relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <motion.div 
            className="absolute bottom-0 left-20 w-64 h-64 rounded-full bg-cyan-400/10 blur-3xl"
            animate={{ 
              scale: [1, 1.1, 1],
              opacity: [0.2, 0.3, 0.2]
            }}
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            >
              <Button 
                className="bg-white text-blue-600 hover:bg-blue-50 text-lg px-8 py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group"
                size="lg"
              >
