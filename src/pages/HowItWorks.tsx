  ...
  return <MainLayout>
      ...
      <section className="bg-auto-blue-500 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <motion.p className="text-xl max-w-3xl mx-auto mb-8" initial={{
          opacity: 0
        }} animate={{
          opacity: 1
        }} transition={{
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          amount: 0.2
            ...
            {steps.map((step, index) => <motion.div key={index} className="bg-white rounded-lg p-8 shadow-md hover:shadow-xl transition-shadow duration-300 text-center relative" variants={fadeIn}>
                ...
                <div className="absolute -right-4 top-1/2 transform -translate-y-1/2 hidden lg:block">
                  {index < steps.length - 1 && <ArrowDown className="h-8 w-8 text-auto-blue-300 rotate-[-90deg]" />}
                </div>
              </motion.div>)}
          </motion.div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          amount: 0.2
            ...
            {features.map((feature, index) => <motion.div key={index} className="feature-card" variants={fadeIn}>
                <Card>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <motion.img src="https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?auto=format&fit=crop&w=800&q=80" alt="Technologie d'estimation de véhicules" className="rounded-lg shadow-lg" initial={{
              opacity: 0,
              x: -50
            }} whileInView={{
              opacity: 1,
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => <motion.div key={index} className="bg-white p-6 rounded-lg shadow-md border border-gray-100" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
