...
const HowItWorksSection: React.FC = () => {
  return (
    <section className="py-24 bg-gradient-to-b from-blue-600 via-teal-500 to-cyan-500 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <motion.div 
              className="absolute -right-6 -bottom-6 bg-gradient-to-br from-teal-400 to-green-500 p-4 rounded-full shadow-xl z-20"
          ...
          >
            ...
            >
              <Button 
                className="group bg-white hover:bg-white/90 text-blue-600 font-bold px-8 py-6 text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden" 
                size="lg" 
                asChild
              >
                <Link to="/how-it-works" className="flex items-center">
                  ...
                  <motion.div 
                    className="ml-2 group-hover:ml-4 transition-all duration-300 relative z-10"
                    animate={{ x: [0, 5, 0] }}
                  ...
                  <motion.div 
                    className="absolute left-0 top-0 h-full w-0 bg-gradient-to-r from-blue-100 to-cyan-100 group-hover:w-full transition-all duration-500"
                    style={{ zIndex: 1 }}
                  />
                </Link>
              </Button>
