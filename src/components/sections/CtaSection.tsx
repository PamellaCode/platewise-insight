...
const CtaSection: React.FC = () => {
  return (
    <section className="py-20 bg-gradient-to-r from-argus-red-400/90 via-argus-violet-400/90 to-argus-blue-400/90 text-white backdrop-blur-sm">
      <div className="container mx-auto px-4 text-center">
        ...
        >
          ...
          <Button 
            className="bg-white hover:bg-gray-100 text-argus-violet-500 font-bold text-lg px-8 py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300" 
            size="lg" 
            asChild
          >
