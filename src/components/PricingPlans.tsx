  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center md:items-stretch gap-8 px-4">
      {plans.map((plan, index) => (
        <div key={plan.name} className="relative w-full">
          <Card 
          ...
          >
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-gray-50/80 backdrop-blur-sm p-3 group-hover:bg-white/90 transition-colors duration-500">
                  ...
                  <div className="w-full bg-gray-200 h-2 rounded-full mt-2 overflow-hidden">
                    <div 
                      className={`${plan.color} h-2 rounded-full transition-all duration-1000 ease-in-out`} 
                      style={{
            ...
            <CardFooter className="mt-auto pt-6 relative z-10">
              <Button 
                ...
                className={`w-full ${plan.buttonVariant === 'outline' ? plan.textColor + ' border-' + plan.textColor.split('-')[1] + ' hover:bg-' + plan.textColor.split('-')[1] + '/10' : 'bg-auto-blue-500 hover:bg-auto-blue-600'} py-6 text-base font-semibold transition-all duration-300 group-hover:scale-105 group-hover:shadow-md`} 
                asChild
              >
